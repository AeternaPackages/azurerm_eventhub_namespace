...
module "eventhub_namespaces" {
  source              = "git::https://github.com/AeternaModules/azurerm_eventhub_namespace.git?ref=v4.80.0"
  eventhub_namespaces = local.eventhub_namespaces
}

module "eventhub_namespace_customer_managed_keys" {
  source                                   = "git::https://github.com/AeternaModules/azurerm_eventhub_namespace_customer_managed_key.git?ref=v4.80.0"
